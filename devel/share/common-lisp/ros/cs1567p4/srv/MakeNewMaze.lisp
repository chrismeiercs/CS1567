...
(cl:defmethod cl:initialize-instance :after ((m <MakeNewMaze-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MakeNewMaze-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cs1567p4-srv:<MakeNewMaze-request> is deprecated: use cs1567p4-srv:MakeNewMaze-request instead.")))

(cl:ensure-generic-function 'cols-val :lambda-list '(m))
(cl:defmethod cols-val ((m <MakeNewMaze-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cs1567p4-srv:cols-val is deprecated.  Use cs1567p4-srv:cols instead.")
  (cols m))

(cl:ensure-generic-function 'rows-val :lambda-list '(m))
(cl:defmethod rows-val ((m <MakeNewMaze-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cs1567p4-srv:rows-val is deprecated.  Use cs1567p4-srv:rows instead.")
  (rows m))
...
(cl:defmethod cl:initialize-instance :after ((m <MakeNewMaze-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MakeNewMaze-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cs1567p4-srv:<MakeNewMaze-response> is deprecated: use cs1567p4-srv:MakeNewMaze-response instead.")))

(cl:ensure-generic-function 'ok-val :lambda-list '(m))
(cl:defmethod ok-val ((m <MakeNewMaze-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cs1567p4-srv:ok-val is deprecated.  Use cs1567p4-srv:ok instead.")
  (ok m))
