...
(cl:defmethod cl:initialize-instance :after ((m <GetMazeWall-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetMazeWall-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cs1567p3-srv:<GetMazeWall-request> is deprecated: use cs1567p3-srv:GetMazeWall-request instead.")))

(cl:ensure-generic-function 'col-val :lambda-list '(m))
(cl:defmethod col-val ((m <GetMazeWall-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cs1567p3-srv:col-val is deprecated.  Use cs1567p3-srv:col instead.")
  (col m))

(cl:ensure-generic-function 'row-val :lambda-list '(m))
(cl:defmethod row-val ((m <GetMazeWall-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cs1567p3-srv:row-val is deprecated.  Use cs1567p3-srv:row instead.")
  (row m))

(cl:ensure-generic-function 'direction-val :lambda-list '(m))
(cl:defmethod direction-val ((m <GetMazeWall-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cs1567p3-srv:direction-val is deprecated.  Use cs1567p3-srv:direction instead.")
  (direction m))
...
(cl:defmethod cl:initialize-instance :after ((m <GetMazeWall-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetMazeWall-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cs1567p3-srv:<GetMazeWall-response> is deprecated: use cs1567p3-srv:GetMazeWall-response instead.")))

(cl:ensure-generic-function 'wall-val :lambda-list '(m))
(cl:defmethod wall-val ((m <GetMazeWall-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cs1567p3-srv:wall-val is deprecated.  Use cs1567p3-srv:wall instead.")
  (wall m))
